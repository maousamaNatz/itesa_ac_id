            ...
            <figure class="tag-nav-title">
              <div>
                <figure class="nav-tag nav-title">
                  <article>
                    <img
                      src="{{ asset('lib/default_media/logos.png') }}"
                      alt="logo itesa "
                    />
        ...
        <header id="header" class="header">
          <div id="prodi-head" class="prodi-head">
                  ...
                  <div id="title-content" class="title-content">
                    <div>
                      ...
                      <div id="sub-judul" class="sub-judul">
                        <h1 id="rekayasa" class="">Sains</h1>
                        <h1 id="rpl" class="">Aktuaria</h1>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div id="image-content" class="image-content">
              <img
                src="{{ asset('lib/default_media/Kampus-1-ITESA-Muhammadiyah-Semarang-pmb-itesa.jpeg') }}"
                alt=""
              />
            </div>
          </div>
                ...
                <div id="card-visi" class="visi">
                  <div>
                    ...
                    <p id="visi-desc">
                      ...
                      Profesional Berdasarkan Nilai-Nilai Islam yang
                      Berkemajuan.
                    </p>
                  </div>
                </div>
                  ...
                  <div>
                    <div id="card-1" class="card-1 fade-in">
                      ...
                      <div class="list-txt fade-in">
                        <ul>
                          ...
                          <li>
                            Melaksanakan riset untuk pengembangan keilmuan Sains
                            Aktuaria dan pemenuhan kebutuhan lokal dan nasional.
                          </li>
                          <li>
                            Menerapkan ilmu Sains Aktuaria untuk mendukung
                    ...
                    <div id="card-2" class="card-2 fade-in">
                      <div class="list-card-txt fade-in">
                        ...
                        <ol>
                          <li>
                            Untuk menghasilkan lulusan Sarjana Sains Aktuaria
                          ...
                          <li>
                            ...
                            keilmuan Sains Aktuaria yang sesuai dengan kebutuhan
                            masyarakat dan perkembangan teknologi terkini dengan
                            menghasilkan karya yang dapat diakui baik secara
                          ...
                          <li>
                            ...
                            pengembangan keilmuan Sains Aktuaria.
                          </li>
                        </ol>
                      </div>
                    </div>
              ...
              <div class="gallery-wrap fade-in">
                <div id="photo-column" class="photo-column fade-in">
                  <div id="image-column" class="image-column fade-in">
                    <img src="{{ asset('lib/default_media/_ੈ✩‧₊˚.jpeg') }}" alt="" />
                  </div>
                  <div id="image-column" class="image-column fade-in">
                    <img src="{{ asset('lib/default_media/_ੈ✩‧₊˚.jpeg') }}" alt="" />
                  </div>
          ...
          <div id="article-wrap" class="article-wrap fade-in">
            <div id="article-content" class="article-content fade-in">
              <div class="head-content-text fade-in">
                <h1>Berita</h1>
                <h1 id="terkini" class="fade-in">Sains Aktuaria</h1>
              </div>
                ...
                <div id="content" class="news-content fade-in">
                  <div>
                    <div class="news-image fade-in">
                      ...
                      @else
                        <img src="{{ asset('lib/default_media/default-news.jpeg') }}" alt="Default Image" />
                      @endif
                    </div>
                    <div class="news-title fade-in">
                      <div class="news-h1 fade-in">
                        <h1>{{ Str::limit($article->title, 100) }}</h1>
                      </div>
              ...
              <div class="text-center mt-4 fade-in">
                <a href="{{ route('berita.category', 'sains-aktuaria') }}" class="btn-more-news">
                  Lihat Semua Berita
                </a>
              </div>
            </div>
